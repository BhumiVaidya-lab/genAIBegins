...
public class BookCartPlugin {
    ...
    /**
     * In general OpenAI returns the correct answer but there is always an exception that it cannot convert the String to the com.epam.training.gen.ai.model.BookInfo
     */
//    @DefineKernelFunction(
//            name = "getReaderCart",
//            description = "Returns the books information from the Reader's current cart, including the total items in the cart",
//            returnType = "java.util.List",
//            returnDescription = "The list of objects of com.epam.training.gen.ai.model.BookInfo",
...
//    }
    ...
    @DefineKernelFunction(
            ...
            returnType = "com.epam.training.gen.ai.model.BookInfo",
